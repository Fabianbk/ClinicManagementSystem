...
export async function GET(
  ...
  try {
    ...
    const backendUrl = cleanBase.endsWith("/api")
      ? `${cleanBase}/documents/intake-form/treatment/${recordTreatmentId}`
      : `${cleanBase}/api/documents/intake-form/treatment/${recordTreatmentId}`;
    ...
    return new NextResponse(blob, {
      ...
      headers: {
        ...
        "Content-Disposition":
          ...
          `attachment; filename="treatment-record-${recordTreatmentId}.docx"`,
      },
    });
  } catch (err: unknown) {
